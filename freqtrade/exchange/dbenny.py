...
class Dbenny(Exchange):
    """Dbenny exchange class.
    ...
    def dry_run_liquidation_price(
        ...
        """
        Optimized
        Docs: https://Dbenny.gitbook.io/Dbenny-docs/trading/liquidations
    ...
    def fetch_order(self, order_id: str, pair: str, params: dict | None = None) -> CcxtOrder:
        ...
        if (
            ...
            # Dbenny does not fill the average price in the order response
